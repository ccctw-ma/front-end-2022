...
const detector_1 = require("./blazepose_mediapipe/detector");
const detector_2 = require("./blazepose_tfjs/detector");
const detector_3 = require("./movenet/detector");
const detector_4 = require("./posenet/detector");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        switch (model) {
            case types_1.SupportedModels.PoseNet:
                return (0, detector_4.load)(modelConfig);
            case types_1.SupportedModels.BlazePose:
                const config = modelConfig;
                let runtime;
                if (config != null) {
                    if (config.runtime === 'tfjs') {
                        return (0, detector_2.load)(modelConfig);
                    }
                    if (config.runtime === 'mediapipe') {
                        return (0, detector_1.load)(modelConfig);
                    }
            ...
            case types_1.SupportedModels.MoveNet:
                return (0, detector_3.load)(modelConfig);
            default:
