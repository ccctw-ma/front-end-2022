...
const keypoint_tracker_1 = require("./keypoint_tracker");
describe('Keypoint tracker', () => {
    ...
    it('Instantiate tracker', () => {
        const kptTracker = new keypoint_tracker_1.KeypointTracker(trackerConfig);
    ...
    it('Compute OKS', () => {
        ...
        const d = 0.1;
        const expectedOks = (1 + 1 + Math.exp(-1 * Math.pow(d, 2) / (2 * boxArea * Math.pow(x, 2)))) / 3;
