...
exports.load = void 0;
const tfc = __importStar(require("@tensorflow/tfjs-converter"));
const tf = __importStar(require("@tensorflow/tfjs-core"));
const bounding_box_tracker_1 = require("../calculators/bounding_box_tracker");
const keypoint_tracker_1 = require("../calculators/keypoint_tracker");
const types_1 = require("../calculators/types");
...
const keypoints_one_euro_filter_1 = require("../shared/filters/keypoints_one_euro_filter");
const low_pass_filter_1 = require("../shared/filters/low_pass_filter");
const types_2 = require("../types");
const util_1 = require("../util");
const constants_3 = require("./constants");
const crop_utils_1 = require("./crop_utils");
...
class MoveNetDetector {
     ...
     * @return A `Pose`.
     */
    runSinglePersonPoseModel(inputImage) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (tf.getBackend() !== 'webgpu') {
                ...
                inferenceResult = yield outputTensor.data();
            }
            outputTensor.dispose();
            const pose = { keypoints: [], score: 0.0 };
            let numValidKeypoints = 0;
            for (let i = 0; i < constants_3.NUM_KEYPOINTS; ++i) {
                pose.keypoints[i] = {
     ...
     */
    runMultiPersonPoseModel(inputImage) {
        return __awaiter(this, void 0, void 0, function* () {
            const outputTensor = this.moveNetModel.execute(inputImage);
            ...
            outputTensor.dispose();
            const poses = [];
            const numInstances = inferenceResult.length / constants_3.MULTIPOSE_INSTANCE_SIZE;
            for (let i = 0; i < numInstances; ++i) {
                poses[i] = { keypoints: [] };
                const boxIndex = i * constants_3.MULTIPOSE_INSTANCE_SIZE + constants_3.MULTIPOSE_BOX_IDX;
                poses[i].box = {
                ...
                const scoreIndex = i * constants_3.MULTIPOSE_INSTANCE_SIZE + constants_3.MULTIPOSE_BOX_SCORE_IDX;
                poses[i].score = inferenceResult[scoreIndex];
                poses[i].keypoints = [];
                for (let j = 0; j < constants_3.NUM_KEYPOINTS; ++j) {
                    poses[i].keypoints[j] = {
     ...
     * @return An array of `Pose`s.
     */
    estimatePoses(image, estimationConfig = constants_3.MOVENET_ESTIMATION_CONFIG, timestamp) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const imageTensor3D = (0, image_utils_1.toImageTensor)(image);
            const imageSize = (0, image_utils_1.getImageSize)(imageTensor3D);
            ...
            if (!this.multiPoseModel) {
                poses =
                    yield this.estimateSinglePose(imageTensor4D, imageSize, timestamp);
            }
            else {
                poses =
                    yield this.estimateMultiplePoses(imageTensor4D, imageSize, timestamp);
            }
     ...
     * @return An array of `Pose`s.
     */
    estimateSinglePose(imageTensor4D, imageSize, timestamp) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.cropRegion) {
            ...
            const pose = yield this.runSinglePersonPoseModel(croppedImage);
            ...
            const nextCropRegion = (0, crop_utils_1.determineNextCropRegion)(this.cropRegion, pose.keypoints, this.keypointIndexByName, imageSize);
     ...
     * @return An array of `Pose`s.
     */
    estimateMultiplePoses(imageTensor4D, imageSize, timestamp) {
        return __awaiter(this, void 0, void 0, function* () {
            let resizedImage;
            let resizedWidth;
            let resizedHeight;
            ...
            paddedImage.dispose();
            let poses = yield this.runMultiPersonPoseModel(paddedImageInt32);
 ...
 */
function load(modelConfig = constants_3.MOVENET_CONFIG) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!!config.modelUrl) {
            ...
            model = yield tfc.loadGraphModel(config.modelUrl, { fromTFHub });
        }
        else {
            let modelUrl;
            if (config.modelType === constants_3.SINGLEPOSE_LIGHTNING) {
            ...
            model = yield tfc.loadGraphModel(modelUrl, { fromTFHub });
        }
