...
function decodeSinglePose(heatmapScores, offsets, outputStride) {
    return __awaiter(this, void 0, void 0, function* () {
        let totalScore = 0.0;
        const heatmapValues = (0, argmax2d_1.argmax2d)(heatmapScores);
        const [scoresBuffer, offsetsBuffer, heatmapValuesBuffer] = yield Promise.all([heatmapScores.buffer(), offsets.buffer(), heatmapValues.buffer()]);
        const offsetPoints = (0, util_1.getOffsetPoints)(heatmapValuesBuffer, outputStride, offsetsBuffer);
        const offsetPointsBuffer = yield offsetPoints.buffer();
        const keypointConfidence = Array.from((0, util_1.getPointsConfidence)(scoresBuffer, heatmapValuesBuffer));
