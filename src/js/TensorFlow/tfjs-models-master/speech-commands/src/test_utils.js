...
exports.expectTensorsClose = void 0;
...
function expectTensorsClose(actual, expected, epsilon) {
    ...
    const actualData = actual instanceof tfjs_core_1.Tensor ? actual.dataSync() : actual;
    const expectedData = expected instanceof tfjs_core_1.Tensor ? expected.dataSync() : expected;
