...
function expectSegmenter(segmenter, image, segmentationImage) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const actualBooleanMask = (0, test_util_1.imageToBooleanMask)((yield segmentation.mask.toImageData()).data, 255, 0, 0);
...
(0, jasmine_util_1.describeWithFlags)('MediaPipe SelfieSegmentation static image ', jasmine_util_1.BROWSER_ENVS, () => {
    let segmenter;
    let image;
    ...
    it('general model test.', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        segmenter = yield bodySegmentation.createSegmenter(model, Object.assign(Object.assign({}, MEDIAPIPE_MODEL_CONFIG), { modelType: 'general' }));
    ...
    it('landscape model test.', () => __awaiter(void 0, void 0, void 0, function* () {
        // Note: this makes a network request for model assets.
        const model = bodySegmentation.SupportedModels.MediaPipeSelfieSegmentation;
        segmenter = yield bodySegmentation.createSegmenter(model, Object.assign(Object.assign({}, MEDIAPIPE_MODEL_CONFIG), { modelType: 'landscape' }));
        expectSegmenter(segmenter, image, segmentationImage);
        segmenter.dispose();
    }));
});
