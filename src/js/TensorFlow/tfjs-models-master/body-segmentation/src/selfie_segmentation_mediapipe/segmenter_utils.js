...
function validateModelConfig(modelConfig) {
    if (modelConfig == null) {
        return Object.assign({}, constants_1.DEFAULT_MEDIAPIPE_SELFIE_SEGMENTATION_MODEL_CONFIG);
    }
...
function validateSegmentationConfig(segmentationConfig) {
    if (segmentationConfig == null) {
        return Object.assign({}, constants_1.DEFAULT_MEDIAPIPE_SELFIE_SEGMENTATION_SEGMENTATION_CONFIG);
    }
