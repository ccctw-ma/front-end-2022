 ...
 * =============================================================================
 */
const constants_1 = require("../calculators/constants");
const low_pass_filter_1 = require("./low_pass_filter");
/**
...
class RelativeVelocityFilter {
    ...
    apply(value, microSeconds, valueScale) {
        ...
        if (this.lastTimestamp === -1) {
            ...
            const assumedMaxDuration = constants_1.SECOND_TO_MICRO_SECONDS / 30;
            ...
            const velocity = cumulativeDistance / (cumulativeDuration * constants_1.MICRO_SECONDS_TO_SECOND);
