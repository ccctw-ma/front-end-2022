...
function shiftImageValue(image, outputFloatRange) {
    ...
    const valueRange = (0, image_utils_1.transformValueRange)(0, 255, outputFloatRange[0] /* min */, outputFloatRange[1] /* max */);
    // Shift value range.
    return tf.tidy(() => tf.add(tf.mul(image, valueRange.scale), valueRange.offset));
}
