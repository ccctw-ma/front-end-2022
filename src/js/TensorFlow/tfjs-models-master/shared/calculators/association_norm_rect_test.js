 ...
 * =============================================================================
 */
const association_norm_rect_1 = require("./association_norm_rect");
//  0.4                                         ================
//                                              |    |    |    |
//  0.3 =====================                   |   NR2   |    |
//      |    |    |   NR1   |                   |    |    NR4  |
...
describe('calculateAssociationNormRect', () => {
    it('3 inputs.', () => __awaiter(void 0, void 0, void 0, function* () {
        const minSimilarityThreshold = 0.1;
        const inputList0 = [nr0, nr1, nr2];
        const inputList1 = [nr3, nr4];
        const inputList2 = [nr5];
        const result = (0, association_norm_rect_1.calculateAssociationNormRect)([inputList0, inputList1, inputList2], minSimilarityThreshold);
    ...
    it('single input.', () => __awaiter(void 0, void 0, void 0, function* () {
        const minSimilarityThreshold = 0.1;
        const inputList0 = [nr3, nr5];
        const result = (0, association_norm_rect_1.calculateAssociationNormRect)([inputList0], minSimilarityThreshold);
